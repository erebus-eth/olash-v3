...
void PHViewer::loadShaders(const GLchar* vShaderFile, const GLchar* fShaderFile)
{
    ...
    intensityParam = glGetUniformLocation(program, "intensity");
    indirectIntensityParam = glGetUniformLocation(program, "indirectIntensity");
    normalParam = glGetUniformLocation(program, "normal");
    // --------------------------------------------
...
void PHViewer::draw()
{
    ...
    glUniform3fv(lightPosParam, 1, glm::value_ptr(glm::vec3(0, 0, 0))); // en el centro más o menos alto
    glUniform1f(intensityParam, 0.2);
    glUniform1f(indirectIntensityParam, 0.06); // hay gran 10/2 para simular la noche
...
int main(int argc, char** argv)
{
    ...
    phViewer.loadShaders(
            "/home/nemo/Escritorio/PR1/Ej3/src/shaders/vpassthrough.glsl",
            "/home/nemo/Escritorio/PR1/Ej3/src/shaders/fpassthrough.glsl"
            );
    phViewer.loadModel(
            "/home/nemo/Escritorio/PR1/Ej3/src/models/malla.obj"
            );
    // --------------------------------------------
